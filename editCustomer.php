                            ...
                            <form action="update.php" mehthod="get">
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="col-sm-1-7">
                                            <input type="text" class="form-control" value="<?=$customer['middle_name']?>" name="middle_name"
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="col-sm-1-7">
                                            <input type="text" class="form-control" value="<?=$customer['national_id']?>" name="national_id"
                                                placeholder="" require>
