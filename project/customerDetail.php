...
session_start();
   ...
   $customer=getCustomerTransaction($pdo,$id);
                    ...
                    <div class="row">
                        ...
                        <div class="container">
                            <table  class="col-12 table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    foreach($customer as $customerTransaction){
                                        echo "<tr>
                                                <td><img src='$customerTransaction[flag]' width='40' height='25' alt='flag'>$customerTransaction[currency_code]</td>
