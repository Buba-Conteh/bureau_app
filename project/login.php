                  ...
                  <?php
                        if (isset($_SESSION['validation'])) {
                          ...
                          echo"
                           ...
                           unset($_SESSION['validatin']);
                        }
                  ?>
                    <h1 class="h4 text-gray-900 mb-4">Welcome Back!</h1>
                  </div>
                  <form class="user" Method="post" action="includes/processlogin.php" >
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" value="1" class="custom-control-input" id="show">
